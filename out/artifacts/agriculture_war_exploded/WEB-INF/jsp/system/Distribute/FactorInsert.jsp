	...
	<form class="layui-form" id="form1">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="factor_name" placeholder="请输入气象要素名称" autocomplete="off" class="name layui-input" id='one'>
                </div>
            </div>
       		<div class="layui-form-item">
              <label class="layui-form-label">适宜</label>
              <div class="layui-input-block">
                <input type="text" name="suitmid" placeholder="请输入适宜温度" autocomplete="off" class="wded layui-input" id="two">
              </div>
            </div>
            <div class="layui-form-item">
              <label class="layui-form-label">适宜下限</label>
              <div class="layui-input-block">
                <input type="text" name="suitlow" placeholder="请输入适宜下限温度" autocomplete="off" class="wded layui-input" id="three">
              </div>
            </div>
            <div class="layui-form-item">
              <label class="layui-form-label">较适宜下限</label>
              <div class="layui-input-block">
                <input type="text" name="resuitlow" placeholder="请输入较适宜下限温度" autocomplete="off" class="wded layui-input" id="four">
              </div>
            </div>
            <div class="layui-form-item">
              <label class="layui-form-label">适宜上限</label>
              <div class="layui-input-block">
                <input type="text" name="suithigh" placeholder="请输入适宜上限温度" autocomplete="off" class="wded layui-input" id="five">
              </div>
            </div>
            <div class="layui-form-item">
              <label class="layui-form-label">较适宜上限</label>
              <div class="layui-input-block">
                <input type="text" name="resuithigh" placeholder="请输入较适宜温度上限" autocomplete="off" class="wded layui-input" id="six">
              </div>
            </div>
            <div class="layui-form-item">
            <div class="layui-input-block">
	  ...
	  $('.add').on('click', function() {
		 ...
		 if(one.length<1||two.length<1||three.length<1||four.length<1||five.length<1||six.length<1){
			...
			$.ajax({
		        cache: false,
		        type: "POST",
		        url:"${pageContext.request.contextPath }/insertFactor.action",
