...
<div class="admin-main">
	<form class="layui-form" id="form1">
             ...
             <div class="layui-form-item">
              <label class="layui-form-label">生长发育期</label>
              <div class="layui-input-block">
                <input type="text" name="grow_name" required lay-verify="required" placeholder="请输入生长发育期" autocomplete="off" class="wded layui-input" >
              </div>
            </div>
            <div class="layui-form-item">
...
layui.use(['form', 'layedit', 'laydate','layer','jquery'], function(){
	  ...
	  $('.add').on('click', function() {
		  var grow_name=$(" input[ name='grow_name' ] ").val();
		  if(grow_name.length<1){
				 layer.msg('添加失败，请输入生长发育期');
				return false;
			 }
				$.ajax({
		        cache: false,
		        type: "POST",
		        url:"${pageContext.request.contextPath }/insertGrowTime.action",
		        ...
		        success: function(data) {
		        	if(data=="success"){
		        		...
		        		layer.msg('添加失败，你输入的生长发育期名称重复，请重新输入');
		        	}
		        },
		        error: function(data) {
