...
<div class="admin-main">
   ...
   <!--   <form class="layui-form" action="" method="post">-->
            <div class="layui-form-item">
                <label class="layui-form-label">作物类别名称</label>
                <div class="layui-input-block">
                    <input type="text" name="croptype_name" lay-verify="name" placeholder="请输入" autocomplete="off" class="name layui-input" >
                </div>
            </div>
            <div class="layui-form-item">
              <label class="layui-form-label">备注</label>
              <div class="layui-input-block">
                <input type="text" name="remarks"  lay-verify="remarks" placeholder="请输入类型" autocomplete="off" class="wded layui-input">
              </div>
            </div>
            <div class="layui-form-item">
            <div class="layui-input-block">
		...
		//添加
			$('.add').on('click',function(){
				...
				$.ajax({
				        ...
				        url:"${pageContext.request.contextPath }/croptypeFormSub.action?croptype_name="+croptype_name+"&&remarks="+remarks,
				        type: "POST",
				        ajax:{},
				    	 ...
				    	 success: function(result) {
							...
							if(result=="failed"){
								layer.msg('添加失败，输入的作物种类早已存在，请重新输入！！！');
							}	  
				        },
				       error: function() {
